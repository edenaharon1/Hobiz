...
class PostsController extends BaseController<IPost> {
     ...
     * @returns Array of posts with comment counts
     */
    ...
    /**
     * Retrieve a specific post by ID with its comments
     * @param req - Request object containing post ID in params
     * @param res - Response object
     * @returns Post object with associated comments
     */
    ...
    /**
     * Create a new post
     * @param req - Request object containing post data (title, content, owner, image)
     * @param res - Response object
     ...
     * @param req - Request object containing post ID in params and user ID from authentication
     * @param res - Response object
     * @returns Updated likes count and list of users who liked the post
     */
    async likePost(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            // Send response with updated likes count and likedBy array
    ...
    /**
     * Update a post's details (title, content, image)
    ...
    async update(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            console.log("Updated post from findByIdAndUpdate:", updatedPost);
